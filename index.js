...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Dark\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=19034375199:+55 2299621-5481\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const mod = [ownerNumber,"19034375199@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["19034375199@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["19034375199@s.whatsapp.net"]//ubah nomor lo
			const premium = ["19034375199@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net"]
...
//@darkYT					
            ...
            case 'onichan':
            case 'bodoh':
                client.sendMessage(from, bufferg, './lindy/baka.mp3', audio/mp3, {quoted: mek, ptt:true})
                break
				case 'daftar':
					client.updatePresence(from, Presence.composing)
		...
		case 'happymod':
			...
			break
				case 'meme':
					...
					reply(mess.wait)
					anu = await fetchJson('https://meme-api.herokuapp.com/gimme/memesbrasil');
...
// recursos anime, random @darm domina vida
          ...
          reply('Espere..')
				...
				case 'belle2':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://4.bp.blogspot.com/-pBwX3-rdXeM/XwTW_9oT_9I/AAAAAAAAPt4/_jmeK-lOJMoE4gPYvhgFqzOp-uKnNN9ygCLcBGAsYHQ/s1600/boabronha_2.jpg`,`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSE2YPM0-oLDCkEZirK92IkJeJq5gv6C9gXA&usqp=CAU`)
